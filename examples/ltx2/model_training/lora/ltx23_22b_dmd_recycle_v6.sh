# LTX-2 19B DMD student + SVI recycle (Stage B) — cross-architecture port of
# wan1.3b_dmd_recycle_v2.sh. Student-side hyperparams mirror the Wan v2 run
# (1-step rollout, ratio 5, α=0.25, sc=0.5, GAN 0.03/0.03, symmetric aug,
# EMA off) for apples-to-apples; LTX-2 deltas are conditioning-interface only.
#
...
OUTPUT_DIR="./models/train/ltx23_22b_dmd_recycle_v6"
