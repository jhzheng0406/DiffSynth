...
accelerate launch \
  ...
  --output_path "./models/train/LTX-2-19b_lora_cartoon_sink_recycle_v5" \
  --lora_base_model "dit" \
  ...
  --use_pose_control \
  --preset_lora_path "models/Lightricks/LTX-2-19b-IC-LoRA-Pose-Control/ltx-2-19b-ic-lora-pose-control.safetensors" \
