...
#   - output: wan14b_dmd_recycle_v2_cartoon
...
OUTPUT_DIR="./models/train/wan14b_dmd_recycle_v2_cartoon_gentle"
TEACHER_DIR="./models/train/Wan2.1-Fun-V1.1-14B-Control_lora_cartoon_sink_recycle"
...
accelerate launch \
    ...
    --learning_rate_student 2e-6 --learning_rate_critic 5e-6 \
    --ema_start_step 999999999 \
    --gan_g_weight 0.03 --gan_d_weight 0.03 \
    --gan_feature_layers "13,21,29" --gan_ffn_dim 4096 --gan_num_heads 40 --no_gan_offload \
    ...
    --grad_clip 0.5 \
    --plp \
    --base_model_id PAI/Wan2.1-Fun-V1.1-14B-Control \
    --shared_base \
    --latent_cache ./data/cartoon_15s/latent_cache_14b \
    --num_epochs 5 --save_steps ${SAVE_STEPS:-50} \
