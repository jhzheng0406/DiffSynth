...
#   - output: wan14b_dmd_recycle_v2_realdance_portrait
...
OUTPUT_DIR="./models/train/wan14b_dmd_recycle_v2_realdance_portrait_gentle"
...
accelerate launch \
    ...
    --shared_base \
  --aspect_crop \
    --latent_cache ./data/realdance_portrait/latent_cache_14b \
    --num_epochs 2 --save_steps 50 \
