# One-Forcing / Self-Forcing CAUSAL-AR baseline — PORTRAIT real-human dance (head-to-head vs recycle_v2).
#
...
OUTPUT_DIR="./models/train/wan1.3b_oneforcing_causal_realdance_portrait"
