...
#
# Code: same train_dmd_msgan_v2.py (loss flagged via --msgan_loss_type).

OUTPUT_DIR="./models/train/wan1.3b_dmd_msgan_v4"
...
accelerate launch \
    ...
    examples/wanvideo/model_training/train_dmd_msgan_v2.py \
