...
Based on Wan2.1-Fun-V1.1-1.3B-Control.py. Each chunk is generated within
the model's trained window (49 frames). For chunks k >= 1, reference_image
is set to the LAST FRAME of the previous chunk, anchoring appearance
across the seam.

Usage:
    python Wan2.1-Fun-V1.1-1.3B-Control-Long.py
"""
...
SEED             = 42
FPS              = 16
SAVE_PATH        = "samples/long_chunk_chain_V1.1_baseline"
...
fname = f"V1.1{ref_tag}_chunks{NUM_CHUNKS}x{CHUNK_FRAMES}_{HEIGHT}x{WIDTH}_seed{SEED}_fps{FPS}.mp4"
